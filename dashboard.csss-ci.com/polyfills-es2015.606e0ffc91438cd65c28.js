        ...
        ! function (e) {
          ...
          class i {
            ...
            runTask(e, t, n) {
              ...
              try {
                ...
                e.state !== v && e.state !== Z && (e.type == P || e.data && e.data.isPeriodic ? o && e._transitionTo(T, E) : (e.runCount = 0, this._updateTaskCount(e, -1), o && e._transitionTo(v, E, v))), O = O.parent, j = r
              }
            }
            scheduleTask(e) {
          ...
          function T(e, o, s) {
            ...
            if (null === e[g]) {
              ...
              if (!1 !== o && s instanceof D && s.hasOwnProperty(g) && s.hasOwnProperty(k) && null !== s[g]) w(s), T(e, s[g], s[k]);
                ...
                e[g] = o;
                const c = e[k];
                if (e[k] = s, e[_] === _ && !0 === o && (e[g] = e[y], e[k] = e[m]), !1 === o && s instanceof Error) {
              ...
              A = function (t, n, r, s, a = !1, i = !1) {
                return function () {
                  ...
                  const z = c.constructor.name,
                    C = L[z];
                  C && (Z = C[l]), Z || (Z = z + n + (v ? v(l) : l)), b.options = d, y && (b.options.once = !1), b.target = c, b.capture = _, b.eventName = l, b.isExisting = P;
                  const M = p ? R : void 0;
                  M && (M.taskData = b);
                  const A = T.scheduleEventTask(Z, u, M, r, s);
                  return b.target = null, M && (M.taskData = null), y && (d.once = !0), (N || "boolean" != typeof A.options) && (A.options = d), A.target = c, A.capture = _, A.eventName = l, h && (A.originalDelegate = u), i ? S.unshift(A) : S.push(A), a ? c : void 0
                }
              };
            return y[r] = A(T, h, P, C, _), S && (y.prependListener = A(S, ".prependListener:", (function (e) {
              ...
              if (_) return this
            }, z(y[r], T), z(y[s], E), Z && z(y[c], Z), w && z(y[a], w), !0
          }
          let k = [];
