...
class Authorization_Token {
    ...
    public function __construct() {
        ...
        $this->token_get = $this->CI->input->get('access_token', TRUE);
    }
    ...
    public function validateToken() {
        ...
        $token_data = $this->tokenIsExist();
        if ($token_data['status'] === TRUE) {
            try {
                try {
                    $token_decode = JWT::decode($this->token_get, $this->token_key, array($this->token_algorithm));
                } catch (Exception $e) {
    ...
    public function tokenIsExist() {
        if (!empty($this->token_get)) {
            return ['status' => TRUE, 'key' => $this->token_get];
        }
